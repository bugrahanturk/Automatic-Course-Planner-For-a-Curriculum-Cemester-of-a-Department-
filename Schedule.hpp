...
public:
	...
	bool takeService(vector<Course *>& myCourses, string file) throw();

	bool takeBusy(vector<Course *>& myCourses, string file)throw();

	bool putRest(vector<Course *>& myCourses);

	bool exportFile(string file) throw();
...
private:
	...
	inline bool eraseBusies(vector<Course *>& myCourses, string file) throw();
