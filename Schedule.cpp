...
bool Schedule::takeService(vector<Course*>& myCourses, string file)throw()
{
    ifstream fin;
...
bool Schedule::takeBusy(vector<Course*>& myCourses, string file)throw()
{
    ifstream fin;
    string code, day, time;
    int dayNum, timeNum;
...
bool Schedule::exportFile(string file)throw()
{
    ofstream fout;
    try
    {
...
bool Schedule::eraseBusies(vector<Course*>& myCourses, string file)throw()
{
    ifstream fin;
    string code, str;
